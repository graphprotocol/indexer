...
| eip155:1261120           | zkatana       | Yes         | Yes          | Yes               | Yes                  | Yes              |
...
| Substreams: zkatana      |               | Yes         | Yes          | Yes               | Yes                  | Yes              | 
...
```
graph-node: >=0.34.0 <0.35.0
```

### Latest Council snapshot
[GGP-0036: Add full protocol support for both Optimism subgraphs and SPS](https://snapshot.org/#/council.graphprotocol.eth/proposal/0xcb7ce4aad9f18961d3a4ebe77a9a6f32f6a6335193f531e2c68f9308346c9e6e)
