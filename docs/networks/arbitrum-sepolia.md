...
| indexer-agent      | [0.25.0-rc.5](https://github.com/graphprotocol/indexer/releases/tag/v0.25.0-rc.5)              |
| indexer-cli        | [0.25.0-rc.5](https://github.com/graphprotocol/indexer/releases/tag/v0.25.0-rc.5)              |
...
| `subgraphs.network.query_url`          | `https://gateway.network.thegraph.com/api/[api-key]/subgraphs/id/eAENt2ctaMdbCY34apzXYkBy2nEYwyojjVxLahsHo9D` |
