...
| Name               | Address                                                                                                                        |
| ------------------ | ------------------------------------------------------------------------------------------------------------------------------ |
| Graph Token (GRT ) | [`0xf8c05dCF59E8B28BFD5eed176C562bEbcfc7Ac04`](https://sepolia.etherscan.io/address/0xf8c05dCF59E8B28BFD5eed176C562bEbcfc7Ac04) |
| Staking            | [`0x865365C425f3A593Ffe698D9c4E6707D14d51e08`](https://sepolia.etherscan.io/address/0x865365C425f3A593Ffe698D9c4E6707D14d51e08) |


[comment]: <> (TODO: CHECK THESE)
...
| `INDEXER_AGENT_NETWORK_SUBGRAPH_DEPLOYMENT` | `--network-subgraph-deployment` | `QmTZD8x7assVzfqwar67TQWaSPnVsTXRFbMLZeZTVhx3qR`                                  |
...
| `INDEXER_AGENT_EPOCH_SUBGRAPH_ENDPOINT`     | `--epoch-subgraph-endpoint`     | `https://api.thegraph.com/subgraphs/name/graphprotocol/arbitrum-sepolia-epoch-block-oracle`|
...
| `INDEXER_SERVICE_NETWORK_SUBGRAPH_DEPLOYMENT` | `--network-subgraph-deployment` | `QmTZD8x7assVzfqwar67TQWaSPnVsTXRFbMLZeZTVhx3qR`                                |
