...
The Graph Network's testnet is on Ethereum, and network information can be found at https://thegraph.com/explorer/network.
...
Other network contracts can be found in [graphprotocol/contracts](https://github.com/graphprotocol/contracts/blob/dev/addresses.json#L2).
...
> This describes indexing & querying features which are experimental or not fully supported for indexing & query rewards and arbitration.
...
[Council snapshot](https://snapshot.org/#/council.graphprotocol.eth)