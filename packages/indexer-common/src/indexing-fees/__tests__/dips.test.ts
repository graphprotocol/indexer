...
describe('DipsManager', () => {
  ...
  describe('initialization', () => {
    test('creates DipsManager when dipperEndpoint is configured', () => {
      const dipsManager = new DipsManager(logger, managementModels, network, graphNode, null)
  ...
  describe('agreement management', () => {
    ...
    beforeEach(async () => {
      ...
      dipsManager = new DipsManager(logger, managementModels, network, graphNode, allocationManager)
