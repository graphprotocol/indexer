...
import * as indexingRuleResolvers from './resolvers/indexing-rules'
import * as statusResolvers from './resolvers/indexer-status'
import * as costModelResolvers from './resolvers/cost-models'
import * as poiDisputeResolvers from './resolvers/poi-disputes'
