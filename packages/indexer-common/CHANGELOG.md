...
- `safety` option in subgraph deployment's indexing rules such that Indexe Agent can decide whether to skip allocations when the previous allocation has been closed by 0x0 POI
